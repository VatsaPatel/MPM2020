                        ...
                        $.each(data.content, function (key, value) {
                            if (value.post_type == 'basic') {
                                ...
                                if (value.media_type == 'image' && value.media != '') {
                                 ...
                                 if (value.media_type == 'gallery' && value.media != '') {

                                     html += '<div class="widget"> <div class="cover overlay overlay-hover"> <img class="cover-image overlay-scale" src="assets/images/alumni_meet_photos/img_m (1).jpg" alt="..."> <div class="overlay-panel overlay-fade overlay-background overlay-background-fixed text-center vertical-align"> <div class="vertical-align-middle"> <h3 class="widget-title margin-bottom-20">Alumni Meet March 2017.</h3> <a href="gallery-in.php" type="button" class="btn btn-outline btn-inverse">Open Gallery</a> </div></div></div></div>';
                                 }
                            ...
                            if (value.post_type == 'basic') {
                                ...
                                if (value.media_type == 'image' && value.media != '') {
                                 ...
                                 if (value.media_type == 'gallery' && value.media != '') {
                                     ...
                                     html += '<div class="widget"> <div class="cover overlay overlay-hover"> <img class="cover-image overlay-scale" src="assets/images/alumni_meet_photos/img_m (1).jpg" alt="..."> <div class="overlay-panel overlay-fade overlay-background overlay-background-fixed text-center vertical-align"> <div class="vertical-align-middle"> <h3 class="widget-title margin-bottom-20">Alumni Meet March 2017.</h3> <a href="gallery.php" type="button" class="btn btn-outline btn-inverse">Open Gallery</a> </div></div></div></div>';
                                 }
